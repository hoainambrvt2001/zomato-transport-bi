...
![Dashboard](https://img.shields.io/badge/dashboard-OnHandBI-1F6FEB)
![License: MIT](https://img.shields.io/badge/license-MIT-green)

[**📊 View the live report →**](https://report.onhandbi.com/public/report?token=eyJhbGciOiJIUzI1NiJ9.eyJwdWJsaWNfbGlua19pZCI6NzA0LCJoYXNfcGFzc2NvZGUiOmZhbHNlLCJ0aW1lIjoxNzgyODA3Nzg1fQ.yM6osDwwyRZYe0tMQ7JBYULYiTPN7xKiRrvxz8KGew8)
...
flowchart LR
    ...
    subgraph BI["BI layer"]
        DB["BR8 · Live operations<br/>dashboard"]
    end
...
| **BR8** | [Live report](https://report.onhandbi.com/public/report?token=eyJhbGciOiJIUzI1NiJ9.eyJwdWJsaWNfbGlua19pZCI6NzA0LCJoYXNfcGFzc2NvZGUiOmZhbHNlLCJ0aW1lIjoxNzgyODA3Nzg1fQ.yM6osDwwyRZYe0tMQ7JBYULYiTPN7xKiRrvxz8KGew8) | Giám sát vận hành giao hàng | Real-time operations monitoring dashboard | OnHandBI |
...
- **BI:** OnHandBI (published live operations report)
...
cells at your local copies (or your own Google Sheet). The operations dashboard (BR8) is
published as a live report (see [Deliverables](#deliverables)).

## Deliverables

- 📊 **Live report:** https://report.onhandbi.com/public/report?token=eyJhbGciOiJIUzI1NiJ9.eyJwdWJsaWNfbGlua19pZCI6NzA0LCJoYXNfcGFzc2NvZGUiOmZhbHNlLCJ0aW1lIjoxNzgyODA3Nzg1fQ.yM6osDwwyRZYe0tMQ7JBYULYiTPN7xKiRrvxz8KGew8
